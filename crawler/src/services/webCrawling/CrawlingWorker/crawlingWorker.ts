...
export default class CrawlingWorker extends Worker
{
    ...
    constructor(crawlerPool: ICrawlersPool, database: IDatabaseWrapper, semaphore: Sema) {
        super(__filename);
    ...
    private ProcessingDoneCallback() {
        ...
        console.log("processing done " + this.executionToRun?.id + " from tid: " + this.threadId);
